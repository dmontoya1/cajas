...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('movement', '0008_movementdailysquarerequestitem_is_replacement'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_office', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movements', to='boxes.BoxColombia', verbose_name='Caja oficina')),
