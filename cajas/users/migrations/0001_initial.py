    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('CC', 'Cédula de ciudadania'), ('CE', 'Cédula de extranjería'), ('PA', 'Pasaporte')], max_length=3, verbose_name='Tipo Documento')),
                ('document_id', models.CharField(default='', max_length=15, verbose_name='Número Documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office_country', models.ManyToManyField(related_name='related_employees', to='office.OfficeCountry', verbose_name='Oficina por País')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ManyToManyField(related_name='partners', to='office.OfficeCountry', verbose_name='Oficina por País')),
